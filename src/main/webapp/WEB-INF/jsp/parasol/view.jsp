                                        ...
                                        <section id="basic-information" class="mb-0 pl-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-auto">
                                                    ...
                                                    <button type="button" class="card ts-item ts-card ts-result border" title="설치주소 변경 버튼" data-placement="Tooltip on bottom" data-toggle="modal" data-target="#modalCenter">
